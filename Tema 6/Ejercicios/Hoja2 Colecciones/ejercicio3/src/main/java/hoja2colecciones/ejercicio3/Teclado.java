...
public class Teclado {
    ...
    public static LocalDateTime IntroFechaHora(String c) {
        ...
        public static String IntroCodigo(String p) {
        Scanner teclado = new Scanner(System.in);
        String cadena="";
        boolean aux=false;
        do{
            try{
                ...
                if(cadena.length()==4){
                    ...
                    throw new Exception("Error en la introduccion del codigo");
                }
            }catch(Exception e){
                System.out.println(e.getMessage());
            }
        ...
        public static String IntroOrigen(String p) {
        Scanner teclado = new Scanner(System.in);
        String cadena="";
        boolean aux=false;
        do{
            try{
                System.out.println(p);
                cadena = teclado.nextLine();
                cadena=cadena.toUpperCase().charAt(0)+cadena.substring(1);
                if(cadena.length()<=15){
                    aux=true;
                }else{
                    throw new Exception("Error en la introduccion del codigo");
