...
public class Ejercicio1 {
    ...
    public static void main(String[] args) {
        ...
        Persona p= new Persona("Ivan","covid",hola);
        Persona p1= new Persona("Gines","Priede",hola);
        
        CuentaCorrientePersonal cc;
        
        cc = new CuentaCorrientePersonal(10.0,p,"ES1730046459615889257979");
        
        
        CuentaCorrienteEmpresa cc1= new CuentaCorrienteEmpresa(100.0,p1,"ES8314653545012699736165");
        
        System.out.println(Entrada.recorrerMapas(cc.listaObjeto()));
        
        System.out.println("Salto");
        
        System.out.println(Entrada.recorrerMapas(cc1.listaObjeto()));    
